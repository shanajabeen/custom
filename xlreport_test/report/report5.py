...
class REPORT5Xlsx(models.AbstractModel):
    _name = 'report.xlreport_test.test_report_id_xlx'
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        # if data['form']['customer_ids']:
        #     domain.append(('partner_id', '=', data['form']['customer_ids'])) 
        ...
        for each in record:
            ...
            worksheet.write('B%s' % new_row, each.invoice_user_id.name)
